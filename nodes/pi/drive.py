...
# ----------------------------------------------
# Hardware constants
# Sourced from config.py - the single source of truth for pins/addresses.
# (2026-07-30: previously duplicated here with a conflicting
#  MOTOR_RIGHT_INVERT value; see SETPOINT-001 evidence.)
# ----------------------------------------------
I2C_FREQ_HZ        = config.PCA_FREQ_HZ     # PCA9685 PWM frequency
PCA_ADDR           = config.PCA_ADDRESS
CH_LEFT            = config.PCA_CH_LEFT     # PCA9685 channel for left  PWM
CH_RIGHT           = config.PCA_CH_RIGHT    # PCA9685 channel for right PWM
GPIO_DIR_LEFT      = config.GPIO_DIR_LEFT   # lgpio GPIO for left  direction
